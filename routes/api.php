...
// Авторизация
Route::middleware('cors', 'vkminiapps', 'throttle:240')->post('/users.auth', [UserController::class, 'auth']);
// Регистрация
Route::middleware('cors', 'vkminiapps', 'throttle:240')->post('/users.register', [UserController::class, 'register']);

// Получаем топ
Route::middleware('cors', 'throttle:240')->post('/top.get', [TopController::class, 'get']);

// Получение данных по ID
Route::middleware('cors', 'token', 'throttle:240')->post('/users.get', [UserController::class, 'get']);
// Заработок
